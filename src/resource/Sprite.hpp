...
namespace lux::resource {
    ...
    private:
        ...
        struct RenderList {
            std::list<core::Pointer<Sprite>> _list;
    ...
    public:
        ...
        void draw() {
            ...
            if (!top._list.size()) {
                ...
                if (next != top._list.end()) {
                    ...
                    top._list.insert(it, core::Pointer<Sprite>(this));
                }
            }
        ...
        static void end() {
            ...
            for (auto& item : list._list) {
                ...
                if (item->_visible && item->_pTexture) {
                    if (SDL_RenderCopyEx(g->getRenderer(), item->_pTexture, &item->_source, &item->_target, item->_angle, &item->_center, item->_flip) != 0) {
                        throw RUNTIME_ERROR(SDL_GetError());
                    }
                }
            }
